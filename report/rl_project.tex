...
\captionof{figure}{Rewards every episode from different processes}
\end{subfigure}
\captionof{figure}{long run of Async n-step Q-Learning, showing gradual improvements}
\label{fig:ASYNC1}
\end{figure}
...
OpenAI. 2022. Atari 2600 preprocessing wrapper [computer program]. Available from: https://github.com/openai/gym/blob/master/gym/wrappers/atari_preprocessing.py
