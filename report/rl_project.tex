...
OpenAI. 2022. \emph{atari_preprocessing gym wrapper}. [computer program]. Available from: https://github.com/openai/gym/blob/master/gym/wrappers/atari_preprocessing.py
